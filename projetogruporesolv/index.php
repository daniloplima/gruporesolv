    ...
    <div class="container">
        <form method="post" action="database.php">
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control"  placeholder="Senha" name="senha_login">
              </div>
             <button type="submit" name="logar_usuario" class="btn btn-primary mb-2">login</button>
        </form>
    </div>
